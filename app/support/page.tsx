...
const Support = () => {
  return (
    <div className="bg-supportPage pb-12 text-white overflow-y-hidden">
      <div className="mb-16">
        <Navbar />
      </div>
      <div className="relative z-10 mt-16">
        ...
        <div className="bg-stone-900 bg-opacity-75 rounded-[5px] border-2 border-neutral-700 border-opacity-75 backdrop-blur-[30px] px-32 py-12 my-24 w-[60%] mx-auto relative z-20">
          <div className="leading-[2rem]">
            <div className="text-center text-white text-opacity-60 text-base font-normal">
              Get in touch
            </div>
            <div className="bg-gradient-to-r from-[#fff] via-[#fff]/80 to-[#9d9ea1]/50 bg-clip-text text-transparent md:text-6xl text-center font-bold pb-1">
              We’d love to help
            </div>
          </div>
          <iframe
